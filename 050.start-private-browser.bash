...
if [[ "${help_wanted}" == "yes" ]] ; then
    ...
    echo ""
    echo "             # SPB supports settings being stored within the SPB configuration file. By creating "
    echo "             # a SPB configuraton file settings may be stored which allow updating and/or overwitting"
    echo "             # of various settings within SPB on your system."
    echo "             # "
    echo "             # A full list of overwitable settings are visiable by looking at the SPB soruce code"
    echo "             # "
    ...
    echo "             #"
    echo "             # If the file \"~/bin/spb-templates/spb.config\" is found on your system, then it will be"
    echo "             # by SPB. The path shown above is the default path for this file. "
    echo "             # "
    echo "             # But remember, it is possible to have multiple SPB configuration files on your system, and"
    echo "             # and to switch between them by using the SPB \"--template-path\" option to alter the template path."
    echo "             # SPB will simply look for a file with the name \"spb.config\" within the SPB template directory."
    echo ""
    echo ""
