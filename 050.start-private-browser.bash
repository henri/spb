...
if [[ "${help_wanted}" == "yes" ]] ; then
    ...
    echo "             #           also stores the configuration file. The 'spb.config' contains various"
    echo "             #           start-private-browser options. If you have set options, then using the"
    echo "             #           --template-path option to select a custom path will result in these"
    echo "             #           options you have set not being detected"
    echo "             #"
