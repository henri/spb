...
if [[ "${help_wanted}" == "yes" ]] ; then
    ...
    echo ""
    echo "             # override the default spb-tamplates path"
    echo "             #    use with caution ; carfully read the note below for detals regarding the use of this option"
    echo "             #"
    ...
    echo "             #           customaizable spb related settings)."
    echo "             #"
