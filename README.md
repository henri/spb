...
> <sub>If you prefer to use spb without using the install/update script (not recommended due to the install script being very easy setup) ; just copy the SBP [project](https://github.com/henri/spb/blob/main/050.start-private-browser.bash) script to your system and make it executable.<sub>
<br/>
