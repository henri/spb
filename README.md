...
Below is a list of SPB supported browsers. Some browsers have better support than others (your millage may vary). Some browsers currently have experimental support by SPB. If you have a browser which is based on Chromium or Firefox, then there is a good chance it will work with SPB.
