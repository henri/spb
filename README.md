...
SPB is an command line based management interface wrapper to your [web browser(s)](https://github.com/henri/spb/blob/main/README.md#sunrise-browser-support).
