...
The built in [templating](https://github.com/henri/spb/blob/main/README.md#spb-templating-support) sub-system provides you with another layer of control. Use SPB to create teamplates, edit and load browser templates. This allows you to start your isolated browser enviroment(s) using your custom pre-configured settings.
