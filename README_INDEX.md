...
SPB is tightly connected with the [FISH](https://fishshell.com/) shell (hence all the ocean references). When you install SPB a number of fish functions will be automatically configurted to help with diving into the web right from the terminal.
